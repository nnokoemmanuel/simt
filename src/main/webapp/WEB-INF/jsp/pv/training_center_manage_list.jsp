	...
	<form id ="form" class="kt-form kt-form--fit kt-margin-b-20">
	    ...
	    <div id="block2" style="display:none;">
		    <div class="row kt-margin-b-20">
	            ...
	            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
	               <center>
	                   <button id="search-candidate" style="width: 50%; margin-top:20px; background-color: #80ad71; border-color: #80ad71; " type="button" class="btn btn-success" title="search Candidates" onClick="searchButtonCandidateList();">
        ...
        <div id="block1">
	        ...
	        <div class="row kt-margin-b-20" id="searchStudents">
				...
				<div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
	               <center>
	                   <button id="searchStudentButton" style="width: 50%; margin-top:20px; background-color: #80ad71; border-color: #80ad71; " type="button" class="btn btn-success" title="search Candidates" onClick="searchButtonCandidateList();">
	                   <i class="la la-search"></i>
			 ...
			 <!--              <div class="col-lg-2 kt-margin-b-10-tablet-and-mobile">
								<label><fmt:message key="student.origin" />:</label>
								<select  id="specialityId" class="form-control kt-input" data-col-index="2">
				                    <option value="0"><fmt:message key="select.all" /></option>
				                    <option value="1">STUDENTSESSION</option>
				                    <option value="2">CONCOUR</option>
								</select>
						     ...
						     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <button title="Search by Origin | Rechercher par Origine"
                                     style="width: 8%; margin-top:-55px; background-color: #80ad71; border-color: #80ad71; " type="button" class="btn btn-success" class="col-lg-3 kt-margin-b-10-tablet-and-mobile"
				                id="searchID" value="validateSearchOrigin" onclick="validateSearchOrigin();">
				                <i class="la la-search"></i>
				                <fmt:message key="search_msg"/>
				             </button>   -->
    		    ...
    		    <table class="table table-striped- table-bordered table-hover table-checkable dataTable dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="position: relative; width: 1650px;">
				  <thead style="background:#01A8F9;">
					<tr 1 style="color:white"  role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 80.25px;" aria-label="Country: activate to sort column ascending"><fmt:message key="student.origin" /></th>
    						...
    						<c:forEach var="candidate" items="${listToDisplay}">
    						    <c:if test ="${i%2==1}">
                                    <tr  role="row" class="odd clear-odd" id="${candidate.student.id }">
                                        ...
                                        <td tabindex="0" class="sorting_1"><c:out value = "${i}"/></td>
                                        <td>
                                              <c:if test="${candidate.student.speciality.abbreviation == 'MAE' }">
                                                 <fmt:message key="student.origin.studentSession" />
                                              </c:if>
                                               <c:if test="${candidate.student.speciality.abbreviation == 'IPCSR' || candidate.student.speciality.abbreviation == 'DPCSR' }">
                                                  <fmt:message key="student.origin.concour" />
                                              </c:if>
                                        </td>
                                        ...
                                        <td >
                                            <select onchange="manage_action(this.value,'${candidate.id}','studentSession');return false;" class="form-control input-sm">
                                                 <%@include file="training_center_action_candidate.jsp" %>
                                            </select>
                                        </td>
                                    </tr>
                            	</c:if>
...
function getval4()
{
    //alert(sel.value);
        ...
        var speciality= document.getElementById("specialityId").value;
        if(speciality != 0 && sel.value != 0 ){
            document.getElementById("specialityId").style.display = "block";
