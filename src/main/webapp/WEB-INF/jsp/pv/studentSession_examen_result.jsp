		...
		<div class="col-lg-12">
			...
			<div class="kt-portlet">
				...
				<div class="kt-portlet__head-label col-lg-6">
									<h2>
             	                        ${studentSession.student.person.surName}  ${studentSession.student.person.givenName}
									</h2>
								</div>
				...
				<div  id="load-preview-step1" style="color:white;margin-left:42%;margin-right:42%;" > </div>	
				    ...
				    <form class="kt-form kt-form--label-right" id="add_applicant_form" name="add_applicant_form">
					    <input id="applicantId" type="hidden" value="${studentSession.id}">
					    <div class="kt-portlet__body">
							<div id="divBlock">
							
							<div class="form-group row" id="div4">
                            <div class="col-lg-6">
									<label style="color:#564FC1;"><fmt:message key="define.final.result.key" /></label>
                                    <input type="text" id="note" name="note" class="form-control" min="0" max="20" value=" ${studentSession.note} ">
								</div>
								<div class="col-lg-12 kt-align-right">
									<button type="button" class="btn btn-brand"  id="save_final_result" onclick="saveFinalResult('${pageContext.request.contextPath}/studentSession/saveFinalResult', '${studentSession.id}');" >Submit</button>
								</div>
							</div>
						</div>
					</form>
