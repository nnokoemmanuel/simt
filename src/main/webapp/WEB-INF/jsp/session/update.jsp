																								    ...
																								    <form action="" method="post">
																								                 ...
																								                 <input type="hidden" id="id" value="${id}">
																														...
																														<div class="form-group row required" >
																															<label for="sessionDate" class=" col-sm-3 control-label">
																															<span>Session Date*</span></label>
																									                            <div class="form-group row required">
																																
																																<p> <input  id="sessionDate1" name="sessionDate1"  type="text"  value="${session1.sessionDate}" ></p>
																								            ...
																								            <a href="#" class="btn btn-brand btn-elevate btn-icon-sm" onclick="updateExamSession();" class="btn btn-primary"
																						                      title="update session"> Submit </a>
...
<!-- end:: Content -->
		...
		<!--end::Page Scripts -->	
		<script>
		  initializeSessionDatePicker();
		</script>
		
		<script>
	         $('input[name="sessionDate1"]').datepicker({'format':'yyyy-mm-dd'});
        </script>	
		
		<!--  
		<script>
			 $('#sessionDate1').datepicker({'format':'dd/mm/yyyy'});
		</script>	-->
