...
KTUtil.ready(function() {
    ...
    const chars = link.split('=');
     var value = chars[1];
    // expected output: "k"
    if(value == "fr"){
       var langueFr = document.getElementById("francais");
       var langueEn = document.getElementById("anglais");
       if(langueFr == null){
           langueFr.remove();
       }
       if(langueEn == null){
       ...
       alert("mototoiseEN");
        ...
        img.src= "assets/media/flags/195-france.svg";
        var span = document.createElement("span");
        span.className='kt-header__topbar-icon';
        span.id = 'francais';
        span.append(img);
        document.getElementById("langDiv").append(span);
        //document.getElementById("kt-nav__itemFr").classList.remove("kt-nav__item--active");
        //document.getElementById("kt-nav__itemEn").classList.remove("kt-nav__item--active");
        //document.getElementById("kt-nav__itemFr")className = "kt-nav__item--active";
    }else if (value == "en"){
        var langueFr = document.getElementById("francais");
        var langueEn = document.getElementById("anglais");
        if(langueFr != null){
       ...
       // img.src= "assets/media/flags/226-united-states.svg";
        ...
        span.className='kt-header__topbar-icon';
        span.id = 'anglais'
        var str = new String("EN");
        span.append(str);
        document.getElementById("langDiv").append(span);
        //document.getElementById("kt-nav__itemFr").classList.remove("kt-nav__item--active");
        //document.getElementById("kt-nav__itemEn").classList.remove("kt-nav__item--active");
        //document.getElementById("kt-nav__itemEn").className = "kt-nav__item--active";
    }
});

// CSS3 Transitions only after page load(.kt-page-loading class added to body tag and remove with JS on page load)
window.onload = function() {
	if(window.location.href.indexOf('/login') >-1 ){ /// s il sagit de la page de login charge mon worker @MPA :)
	registerServiceWorker();
	}
    KTUtil.removeClass(KTUtil.get('body'), 'kt-page--loading');

    if(window.location.href.indexOf('/login') == -1 && document.getElementById("error_page") == undefined ){ 
    	pollingNotifications(); // poll my notifications on all pages except login pages and exceptions :)
    }
