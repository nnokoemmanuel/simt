		...
		$('#kt_subheader_group_actions_status_change').on('click', "[data-toggle='status-change']", function() {
			...
			if (ids.length > 0) {
				...
				swal.fire({
					...
					html: "Are you sure to update|Etes-vous sûr de mettre à jour " + ids.length + " selected records status to|état des enregistrements sélectionnés à " + status + " ?",
					type: "info",
	
					confirmButtonText: "Yes, update!|Oui, mettez à jour!",
					confirmButtonClass: "btn btn-sm btn-bold btn-brand",
	
					showCancelButton: true,
					cancelButtonText: "No, cancel|Non, annuler",
					cancelButtonClass: "btn btn-sm btn-bold btn-default"
				}).then(function(result) {
					if (result.value) {
						swal.fire({
							title: 'Deleted!',
							text: 'Update done successfully!|Mise à jour réussie!',
							type: 'success',
							buttonsStyling: false,
						...
						swal.fire({
							...
							text: 'No update!|Pas de mise à jour!',
							type: 'error',
							buttonsStyling: false,
							confirmButtonText: "OK",
							confirmButtonClass: "btn btn-sm btn-bold btn-brand",
		...
		$('#kt_subheader_group_actions_delete_all').on('click', function() {
			...
			if (ids.length > 0) {
				...
				swal.fire({
					...
					text: "Are you sure to delete!|Êtes-vous sûr de vouloir supprimer! " + ids.length + " selected records|enregistrements sélectionnés ?",
					type: "danger",

					confirmButtonText: "Yes, delete!|Oui, supprimez!",
					...
					if (result.value) {
						swal.fire({
							title: 'Deleted!|Supprimé!',
							text: 'Your selected records have been deleted!|Vos enregistrements sélectionnés ont été supprimés!',
							type: 'success',
							buttonsStyling: false,
							confirmButtonText: "OK",
							confirmButtonClass: "btn btn-sm btn-bold btn-brand",
						...
						swal.fire({
							title: 'Cancelled|Annulé',
							text: 'Successfully deleted!|Supprimé avec succès',
							type: 'error',
							buttonsStyling: false,
							confirmButtonText: "OK",
							confirmButtonClass: "btn btn-sm btn-bold btn-brand",
