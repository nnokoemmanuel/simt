...
public class HeaderFooterPageEventRejected extends PdfPageEventHelper{
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        String text7 ="Liste des candidats declares rejetes a l'examen national du CAPEC-"+getSpeciality();
        Phrase phrase7 = new Phrase(text7, headFont2);
        String text71 ="List of candidates declared rejected for the competitive examination to train driving school instructors";
