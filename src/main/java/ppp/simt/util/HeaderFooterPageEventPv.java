...
public class HeaderFooterPageEventPv extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        String text7 ="Liste des resultat definitif  a l'examen national du CAPEC-"+getSpeciality();
        Phrase phrase7 = new Phrase(text7, headFont2);
        String text71 ="Final result for the competitive examination to train driving school instructors";
