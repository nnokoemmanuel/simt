...
public class HeaderFooterPageEventDemissionnaire extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        String text7 ="Liste des candidats declares demissionaires a l'examen national du CAPEC-"+getSpeciality();
        Phrase phrase7 = new Phrase(text7, headFont2);
        String text71 ="List of candidates declared resigned for the competitive examination to train driving school instructors";
        ...
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, phrase7, 170, 30, 0);
