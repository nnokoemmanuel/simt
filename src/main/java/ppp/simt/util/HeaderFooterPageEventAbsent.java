...
public class HeaderFooterPageEventAbsent extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        String text7 ="Liste des candidats declares absents a l'examen national du CAPEC-"+getSpeciality();
        Phrase phrase7 = new Phrase(text7, headFont2);
        String text71 ="List of candidates declared absent for the competitive examination to train driving school instructors";
        ...
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, phrase71, 203, 20, 0);
