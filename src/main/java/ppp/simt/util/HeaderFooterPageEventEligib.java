...
public class HeaderFooterPageEventEligib extends PdfPageEventHelper  {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        String text7 ="Liste des candidats  eligibles a l'examen national du CAPEC-"+getSpeciality();
        Phrase phrase7 = new Phrase(text7, headFont2);
        String text71 ="List of eligible candidates for the competitive examination to train driving school instructors";
        ...
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, phrase7, 137, 30, 0);
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, phrase71, 182, 20, 0);
