				    ...
				    <form class="kt-form kt-form--label-right" id="add_applicant_form" name="add_applicant_form">
					    ...
					    <div class="kt-portlet__body">
                            ...
                            <div class="col-lg-6">
                                    ...
                                    <input type="number" id="note" name="note" class="form-control" min="0" max="20">
								</div>
								<div class="col-lg-12 kt-align-right">
									<button type="button" class="btn btn-brand"  id="save_final_result" onclick="saveFinalResult('${pageContext.request.contextPath}/applicant/saveFinalResult', '${applicant.id}', '${applicant.entranceEligibleCenter.id}');" >Submit</button>
								</div>
							</div>
						</div>
					</form>
