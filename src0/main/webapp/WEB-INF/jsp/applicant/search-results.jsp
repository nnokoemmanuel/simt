                                            ...
                                            <select  class="form-control input-sm">
                                                ...
                                                <sec:authorize access="hasRole('ROLE_MANAGE_APPLICANT')">
                                                	<c:if test = "${eligibleCenter.entranceEligibleCenterStatus.id==2 || eligibleCenter.entranceEligibleCenterStatus.id==3}">
	                                                   <option value="applicant" onClick="doGet('${pageContext.request.contextPath}/expertPv/manage_applicants/?eligibleCenterId=${eligibleCenter.id}','kt_content');"><fmt:message key="pv.action.manage.applicant" /></option>
                                                    </c:if>
                                                </sec:authorize>
