...
<form class="kt-form" id="inSlipForm">
	...
	<div class="kt-portlet__foot">
		<div class="kt-form__actions">
			<button  style="margin-bottom:20px"type="button" class="btn btn-primary" onClick=" createSlip('${pageContext.request.contextPath}',0);">Submit</button>
		</div>
	</div>
	...
	<div class="alert alert-outline-danger fade show kt-hidden" role="alert" id="failedSlipExist">
		<div class="alert-icon"><i class="flaticon-questions-circular-button"></i></div>
		<div class="alert-text">An In Slip with same reference number already exist</div>
		<div class="alert-close">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				<span aria-hidden="true"><i class="la la-close"></i></span>
			</button>
