    		...
    		<div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable dataTable dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="position: relative; width: 1650px;">
				  ...
				  <tbody>
                            ...
                            <!--  START SEARCH FILTER ORIGIN FOR STUDENTSESSION - STUDENT  -->
                            
                                <c:set var = "i"  value = "1"/>
    						<c:forEach var="student" items="${student_from_studentSession}">
    						    <c:if test ="${i%2==1}">
                                    <tr  role="row" class="odd clear-odd" id="${student.id}">
                                        <td tabindex="0" class="sorting_1"><c:out value = "${i}"/></td>
                            ...
                            <!--  END START SEARCH FILTER ORIGIN FOR STUDENTSESSION - STUDENT   -->
                            ...
                            <!--  START START SEARCH FILTER ORIGIN FOR CONCOUR  -  APPLICANT   -->
                            
                              <c:if test="${listType == 'StudentSession'}"> 
                            
				            <c:set var = "i"  value = "1"/>
    						<c:forEach var="candidate" items="${student_from_concour}">
    						    <c:if test ="${i%2==1}">
                                    <tr  role="row" class="odd clear-odd" id="${candidate.student.id}">                                   
                                      <td tabindex="0" class="sorting_1"><c:out value = "${i}"/></td>
                                       <td>
                            ...
                            <!--  END START SEARCH FILTER ORIGIN FOR CONCOUR - APPLICANT   -->
